...
export default async function Home() {
  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0 mx-auto">
        <a
      ...
      <div className="my-10 grid w-full max-w-screen-xl animate-fade-up grid-cols-1 gap-5 px-5 md:grid-cols-3 xl:px-0 mx-auto">
