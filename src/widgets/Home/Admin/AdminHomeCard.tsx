...
export default function AdminHomeCard({ updateFeed, props }: args) {
  ...
  return (
    <Card className={" overflow-hidden bg-transparent"} {...props}>
      <CardContent className="grid h-full">
        <div className="hover:scale-105 transition-all z-0 max-h-40 mt-6 rounded-lg border border-dashed border-gray-900/25 px-6 py-3">
          <div className="text-center">
            ...
            <div className=" mt-2 flex flex-col text-sm leading-6 text-gray-600 overflow-ellipsis">
              ...
              <p className="pl-1 text-xs line-clamp-1">или просто перетащите</p>
            </div>
        ...
        <div className="mt-4 flex flex-col">
          <div className="flex flex-col xl:flex-row gap-3 ">
            <Badge
              className="text-xs font-semibold px-2.5 py-0.5 w-full max-w-32 bg-transparent"
              variant={"outline"}
            >
              <select
                required
          ...
          <div className="h-full my-2 font-semibold leading-tight line-clamp-1 break-words flex">
            <input
              required
              placeholder="Название"
              name="name"
              onChange={handleInputChange}
              className="focus:border-border focus:ring-0 focus:outline-none bg-transparent my-auto"
            />
          </div>
